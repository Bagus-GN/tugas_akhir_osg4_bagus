...
class Fragment06 extends StatelessWidget {
  final String title;

  const Fragment06({Key key, this.title}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    HttpConn jsonConn = HttpConn('https://db.ygoprodeck.com/api/v5/cardinfo.php?num=35&type=Trap%20Card');
