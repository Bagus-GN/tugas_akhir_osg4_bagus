...
class Fragment03 extends StatelessWidget {
  final String title;

  const Fragment03({Key key, this.title}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    HttpConn jsonConn = HttpConn('https://db.ygoprodeck.com/api/v5/cardinfo.php?num=35&fname=Monster');
